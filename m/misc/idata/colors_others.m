...
%>@file
%>@brief Returns specified Light-Bertlein colormap.
%>
...
%>       'simple3'     colors extracted from http://particletree.com/features/interfaces-and-color-blindness/
%>
...
function colors = colors_others(n,scheme)
