...
%> @image html Screenshot-uip_block_cascade_base.png
%> <p><b>Usage</b><br>
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @uip_block_cascade_base_OpeningFcn, ...
                   'gui_OutputFcn',  @uip_block_cascade_base_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before uip_block_cascade_base is made visible.
function uip_block_cascade_base_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = uip_block_cascade_base_OutputFcn(hObject, eventdata, handles) 
try
...
function popupmenuBlocks_Callback(hObject, eventdata, handles)
