...
%> @brief writes MATLAB M file irootsetup.m
%>
%> Writes several global variables into a MATLAB source file called <code>irootsetup.m</code>. This file can be later executed to restore
...
ss = ['%      V V', 10, '%  vvvO8 8Ovvv', 10, '% IRoot setup generated at ', datestr(now()), '.', 10, '% Please note that this file may be automatically re-generated by IRoot.', 10, '% Do not add comments, as these will not be kept.', 10, s0, 10, s1, s2];

h = fopen('irootsetup.m', 'w');
fwrite(h, ss);
fclose(h);
irverbose('Wrote file "irootsetup.m"', 1);
