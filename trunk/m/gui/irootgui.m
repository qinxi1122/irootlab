...
%> @cond
function varargout = irootgui(varargin)

% Edit the above text to modify the response to help openspecgui

% Last Modified by GUIDE v2.5 04-Jan-2012 16:20:54
...
ircode_assert();
set(handles.textVersion, 'string', sprintf('Version %s', iroot_version));
...
web('http://bioph.lancs.ac.uk/iroot');

function Untitled_visit_Callback(hObject, eventdata, handles)
web('http://bioph.lancs.ac.uk/iroot');
